---
layout: default
title: "GitHub Secrets Setup Guide"
parent: "Operations"
---
...
gh secret set AZURE_AI_KEY --body "your-foundry-key"  # Required for agents
```
...
| `AZURE_AI_KEY` | Your Azure AI Services key (required for agents) |
...
### 4. AZURE_AI_KEY (Required for agents)

Azure AI Services (Foundry) API key used by the agents.
