    ...
    def speech_config(self):
        ...
        if self._speech_config is None:
            try:
                ...
                logger.info(
                    f"Azure Speech initialized: {self.settings.azure_speech_region}"
                )
    ...
    async def recognize_speech(
        ...
        try:
            ...
            if result.reason == speechsdk.ResultReason.RecognizedSpeech:
                ...
                return SpeechRecognitionResult(
                    text="", confidence=0.0, duration_ms=0, is_final=True
                )
            else:
            ...
            return SpeechRecognitionResult(
                text="[Recognition error]", confidence=0.0, duration_ms=0, is_final=True
            )

    async def synthesize_speech(
        self, text: str, voice_id: VoiceId = VoiceId.ELENA, include_visemes: bool = True
        ...
        try:
            ...
            if result.reason == speechsdk.ResultReason.SynthesizingAudioCompleted:
                return SpeechSynthesisResult(
                    ...
                    visemes=[
                        {"time_ms": v.time_ms, "viseme_id": v.viseme_id}
                        for v in visemes
                    ],
                )
            else:
                ...
                return SpeechSynthesisResult(
                    audio_data=b"", audio_format="audio/mp3", duration_ms=0, visemes=[]
                )
...
async def synthesize_speech(
    text: str, voice_id: VoiceId = VoiceId.ELENA, include_visemes: bool = True
) -> SpeechSynthesisResult:
    """Synthesize speech from text"""
