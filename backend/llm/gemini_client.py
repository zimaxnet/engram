...
Return ONLY valid JSON, no markdown code blocks or explanations."""
    ...
    async def generate_image(self, prompt: str) -> bytes:
        ...
        Currently mocks the Nano Banana Pro API by generating a placeholder image.
        ...
        # Mock implementation - generate a simple placeholder image
        # In a real implementation, this would call the Imagen/Nano Banana Pro API
        try:
            ...
            margin = 50
            offset = 50
            for line in prompt.split(','): # Simple wrapping by comma
                d.text((margin, offset), line.strip(), font=font, fill=(255, 255, 255))
                offset += 50
                
            d.text((margin, 900), "Generated by Sage (Mock)", font=font, fill=(255, 255, 255))
            ...
            logger.error("PIL not installed. Returning empty bytes.")
            return b""
        except Exception as e:
