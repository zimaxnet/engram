...
class AgentRouter:
    ...
    def __init__(self):
        ...
        self._elena_keywords = {
            "requirement", "requirements", "stakeholder", "stakeholders",
            "business", "analysis", "analyze", "user story", "stories",
            "acceptance criteria", "scope", "compliance", "regulation",
            "process", "workflow", "documentation", "specification"
        }
        
        self._marcus_keywords = {
            "project", "timeline", "schedule", "deadline", "sprint",
            "velocity", "estimation", "estimate", "risk", "risks",
            "blocker", "blocked", "resource", "resources", "budget",
            "milestone", "delivery", "shipped", "launch", "release"
        }
