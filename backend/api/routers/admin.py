...
_mock_users = [
    UserProfile(user_id="user-1", email="admin@engram.work", role="admin", active=True, last_login="2024-12-09T10:00:00Z"),
    UserProfile(user_id="user-2", email="dev@engram.work", role="developer", active=True, last_login="2024-12-08T15:30:00Z"),
]

_mock_audit_logs = [
    AuditLog(id="log-1", timestamp="2024-12-09T10:05:00Z", user_id="user-1", action="UPDATE", resource="settings", details="Changed theme to dark"),
    AuditLog(id="log-2", timestamp="2024-12-09T09:00:00Z", user_id="system", action="STARTUP", resource="backend"),
]
